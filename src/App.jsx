      ...
      <div className="track h-screen sticky top-0 flex justify-center items-center">
        <div className="road relative h-50 w-full  overflow-hidden flex items-center">
          ...
          <div className="trail  flex justify-center items-center h-full w-full bg-[#45db7d]">
            <div className="text mr-25 text-[8rem] tracking-wider font-bold">
              WELCOME ITZFIZZ
            </div>
          </div>
        </div>
        ...
        <Box
          classnames={"absolute reveal opacity-0 top-14 right-[31vw]"}
          textclr={"#111"}
          percent={58}
        ...
        />
        <Box
          classnames={"absolute reveal opacity-0 bottom-14 right-[32vw]"}
          textclr={"#111"}
          percent={23}
        ...
        />
        <Box
          classnames={"absolute reveal opacity-0 top-14 right-[11.3vw]"}
          textclr={"#fff"}
          percent={27}
          text={"Increase in pick up point use"}
          bg={"#333"}
        ...
        />
        <Box
          classnames={"absolute reveal opacity-0 bottom-14 right-[10.2vw]"}
          textclr={"#111"}
          percent={40}
          text={"Decreased in customer phone calls"}
          bg={"#fa7328"}
